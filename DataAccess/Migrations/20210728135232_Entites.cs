        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Provider_Manufacturer_ManufacturerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalDiscountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BonusPointsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserDiscount_BonusPoints_BonusPointsId",
                        column: x => x.BonusPointsId,
                        principalTable: "BonusPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDiscount_PersonalDiscount_PersonalDiscountId",
                        column: x => x.PersonalDiscountId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserDiscountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Amount = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Discount = table.Column<decimal>(type: "decimal(18,4)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductOrder_UserDiscount_UserDiscountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOrder_UserDiscountId",
                table: "ProductOrder",
                column: "UserDiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_Provider_ManufacturerId",
                table: "Provider",
                column: "ManufacturerId");

            migrationBuilder.CreateIndex(
                name: "IX_UserDiscount_BonusPointsId",
                table: "UserDiscount",
                column: "BonusPointsId");

            migrationBuilder.CreateIndex(
                name: "IX_UserDiscount_PersonalDiscountId",
                table: "UserDiscount",
                column: "PersonalDiscountId");
